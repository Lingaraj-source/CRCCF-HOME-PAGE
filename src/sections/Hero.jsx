...
export default function Hero() {
  ...
  return (
    <section className="relative w-full h-[85vh] overflow-hidden bg-[#020617]">

      {/* 🔥 GRADIENT BACKGROUND */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#020617] via-[#0B1E3A] to-[#020617]" />
      ...
      <motion.div
        className="absolute w-[300px] h-[300px] bg-cyan-400/20 rounded-full blur-3xl"
        ...
        <div className="max-w-[1440px] mx-auto px-4 md:px-10 lg:px-20 w-full">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-5 py-2 mb-6 rounded-full 
              bg-white/10 border border-white/20 text-sm text-white backdrop-blur-md">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-blue-600 hover:bg-blue-700 px-8 py-3 rounded-xl font-semibold shadow-xl hover:scale-105 transition">
                Begin Your Journey
              </button>

              <button className="bg-white/10 backdrop-blur-md border border-white/30 text-white px-8 py-3 rounded-xl font-semibold hover:bg-white hover:text-black transition">
                Virtual Campus Tour
              </button>
            </div>
