// src/sections/EventBanner.jsx

// Event Banner Section (under features)
// Pixel-perfect layout with left strip + date box + CTA

export default function EventBanner() {
  return (
    <section className="bg-[#f8fafc] px-6 md:px-12 lg:px-20 pb-20">
