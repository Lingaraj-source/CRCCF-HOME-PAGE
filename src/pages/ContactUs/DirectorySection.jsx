    ...
    <section className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-slate-100 animate-[fadeIn_0.3s_ease-out]">
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
        <div className="w-full lg:w-1/3 flex flex-col gap-4">
          <div className="w-full aspect-square rounded-3xl overflow-hidden shadow-md border-4 border-slate-50">
            <img
              src={person.image}
              alt={person.name}
          ...
          >
            ...
            {activeTab === "Contact Details" && (
              <div className="flex flex-col sm:flex-row gap-4 mt-2">
                ...
                >
                  <FaLinkedin size={22} /> LinkedIn Profile
                </a>
                <a
...
const BentoBlock = ({ label, value, className = "" }) => (
  <div
    className={`bg-slate-50 p-6 rounded-3xl border border-slate-100 flex flex-col justify-center ${className}`}
  >
