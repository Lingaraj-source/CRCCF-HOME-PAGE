...
// CompanyMarquee removed; controlled by OurServices page
      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-3xl shadow-xl p-6 md:p-10 mt-6">
          ...
          <p className="text-[#475569] text-lg leading-8">
            We assist with legal information, documentation guidance, and
            support in understanding paperwork related to lawful and
