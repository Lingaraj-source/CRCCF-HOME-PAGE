...
// CompanyMarquee removed; marquee shown only on OurServices page
      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-3xl shadow-xl p-6 md:p-10 mt-6">
          ...
          <p className="text-[#475569] text-lg leading-8">
            We offer branding support, social media promotion, online marketing
            strategies, campaign support, and digital growth services.
          </p>
          <button
