...
// CompanyMarquee removed; displayed only on OurServices
      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-3xl shadow-xl p-6 md:p-10 mt-6">
          ...
          <p className="text-[#475569] text-lg leading-8">
            We offer awareness programs, learning support, workshops, and
            knowledge-based services in cyber, legal, and digital fields.
          </p>
          <button
