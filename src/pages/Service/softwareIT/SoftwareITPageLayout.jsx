  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] px-4 py-6">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">{/* <CompanyMarquee direction="right" /> */}</div>
        ...
        <div className="bg-white rounded-lg sm:rounded-2xl shadow-lg sm:shadow-xl p-6 md:p-8">
          ...
          {/* <button
            onClick={() => navigate('/services/software-it-services')}
            className="mt-6 bg-[#2563EB] hover:bg-[#1D4ED8] text-white px-5 py-3 rounded-xl transition"
          >
            Back to Software & IT Services
          </button> */}
        </div>

        <div className="mt-6">{/* <CompanyMarquee direction="left" /> */}</div>
      </div>
    </div>
  );
};
